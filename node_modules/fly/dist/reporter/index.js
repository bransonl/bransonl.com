...
exports["default"] = function () {
  return this.on("fly_run", function (_ref) {
    ...
    return (0, _flyUtil.log)("Loading plugin " + _fmt2["default"].title, plugin);
    ...
    (0, _flyUtil.trace)(error);
    (0, _flyUtil.log)(_fmt2["default"].error + " failed due to " + _fmt2["default"].error, task, error);
